...
void HP::Start()
{
	...
	HpRender1->SetPosition({ 30, 30 });
	HpRender1->SetScale({ 52, 50 });
	...
	HpRender2->SetPosition({ 90, 30 });
	HpRender2->SetScale({ 52, 50 });
	...
	HpRender3->SetPosition({ 150, 30 });
	HpRender3->SetScale({ 52, 50 });
